...
const IndexPage = () => (
  <Layout>
    <SEO title="Home" keywords={['gatsby', 'application', 'react', 'css', 'animation']} />
    <p>A collection of css magics, including animations, etc.</p>
    <p>See&nbsp;
      <span role="img" aria-label="right-hand-side">👉</span>
      <a href="https://github.com/Cygra/css_magic" target="_blank" rel="noopener noreferrer">
    ...
    <p>The whole content is&nbsp;
      <span role="img" aria-label="down-hand-side">👇</span>
      , press&nbsp;
      <code>⌘ Command + F</code>
      &nbsp;or&nbsp;
      <code>Ctrl + F</code>
